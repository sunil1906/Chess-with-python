...
coin_imgs={}
coin_imgs['br1'] = pygame.image.load('imgs/black_rook.png')
coin_imgs['bh1'] = pygame.image.load('imgs/black_knight.png')
coin_imgs['bb1'] = pygame.image.load('imgs/black_bishop.png')
coin_imgs['bq '] = pygame.image.load('imgs/black_queen.png')
coin_imgs['bk '] = pygame.image.load('imgs/black_king.png')
coin_imgs['bb2'] = pygame.image.load('imgs/black_bishop.png')
coin_imgs['bh2'] = pygame.image.load('imgs/black_knight.png')
coin_imgs['br2'] = pygame.image.load('imgs/black_rook.png')
for i in range(1,9):
    coin_imgs['bp'+str(i)] = pygame.image.load('imgs/black_pawn.png')

coin_imgs['wr1'] = pygame.image.load('imgs/white_rook.png')
coin_imgs['wh1'] = pygame.image.load('imgs/white_knight.png')
coin_imgs['wb1'] = pygame.image.load('imgs/white_bishop.png')
coin_imgs['wq '] = pygame.image.load('imgs/white_queen.png')
coin_imgs['wk '] = pygame.image.load('imgs/white_king.png')
coin_imgs['wb2'] = pygame.image.load('imgs/white_bishop.png')
coin_imgs['wh2'] = pygame.image.load('imgs/white_knight.png')
coin_imgs['wr2'] = pygame.image.load('imgs/white_rook.png')
for i in range(1,9):
    coin_imgs['wp'+str(i)] = pygame.image.load('imgs/white_pawn.png')

coin_imgs['   '] = pygame.image.load('imgs/blank.png')
...
def check_king_in_check(board, piece):
    ...
    if piece[0] == 'w':
        all_piece_list = ['br1','bh1','bb1','bq ','bk ','bb2','bh2','br2','bp1','bp2','bp3','bp4','bp5','bp6','bp7','bp8']
    else:
        all_piece_list = ['wr2','wh2','wb2','wq ','wk ','wb1','wh1','wr1','wp8','wp7','wp6','wp5','wp4','wp3','wp2','wp1']
